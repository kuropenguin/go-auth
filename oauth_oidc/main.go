// reference : https://zenn.dev/satoken/articles/oauth-funiki
package main
...
func setUp() {
	...
	oauth.authEndpoint = "https://accounts.google.com/o/oauth2/auth"
...
func main() {
	setUp()
	r := mux.NewRouter()
	r.Handle("/start", start)
	r.Handle("/callback", callback)
	if err := http.ListenAndServe(":8080", r); err != nil {
		log.Fatal("ListenAndServe:", err)
	}
}

var start = http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
...
var callback = http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
